...
class OfferMapperTest {
    ...
    void shouldMapEntityToOfferDto() {
        Offer offer = new Offer(PRIVATE_LESSON, "Test title", "Test description", BigDecimal.valueOf(10.0), LocalDate.parse("1983-04-05"), new Image(), new ArrayList<>());
        offer.setLikes(10);
        offer.setViews(200);
        ...
        Assertions.assertEquals(offer.getImage(), actual.getImage());
    ...
    void shouldMapOfferDtoToEntity() {
        ...
        Assertions.assertEquals(offerDto.getImage(), actual.getImage());
